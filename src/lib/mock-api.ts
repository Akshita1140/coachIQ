...
const topicPool = (topic: string, mode: Mode, difficulty: Difficulty): string[] => {
...
export async function mockEvaluate(
  ...
  return {
    ...
    strengths: strong
      ? [
          "You structured your answer clearly and stayed on-topic.",
          "Nice use of a concrete example to ground the idea.",
        ]
    ...
    gaps: strong
      ...
      : [
          "Add a specific example to make it tangible.",
          "Expand on the 'why' behind your reasoning.",
        ],
    resource: {
